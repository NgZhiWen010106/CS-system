    ...
    return (
        <div className=' container mx-auto max-w-5xl py-6'>
            <div className="p-5" style={{
                ...
                {/* Four Editor  */}
                <Editor
                    apiKey='gxswbbo2ndnk236d4xhpldaek6vnglybll9b3ee6p4uwzzcs'
                    init={{
                ...
                />
                <p className="text-right">{sizeLimit - count} characters remaining</p>
                ...
                {/* Six Preview Section  */}
                <div className="border border-gray-300 rounded p-4 bg-white mt-3">
