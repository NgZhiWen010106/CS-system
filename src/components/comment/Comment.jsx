    ...
    <section className=" py-8 lg:py-16">
      <div className="max-w-2xl mx-auto px-4">
        ...
        <form className="mb-6">
          ...
          <div
            className="py-2 px-4 mb-4 rounded-lg rounded-t-lg 
              shadow-[inset_0_0_4px_rgba(0,0,0,0.6)] border border-gray-200 relative"
            style={{
              background: mode === 'dark'
                ? '#353b48'
                : 'rgb(226, 232, 240)'
          ...
          >
            ...
            <p className="absolute bottom-0 right-0 text-black-400 text-xs px-2 py-1">
              {100 - commentText.length} characters remaining
            </p>
          </div>
